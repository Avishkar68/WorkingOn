...
import {
  ...
  ArrowRight, Globe, Sparkles, CheckCircle2, XCircle, ArrowUpRight, 
  Terminal, ShieldAlert, BarChart3, Laugh, Heart, Zap, Megaphone, Calendar
} from "lucide-react";
    ...
    <div className="min-h-screen bg-[#020609] text-[#ededed] overflow-x-hidden selection:bg-brand-500/30 font-sans tracking-tight">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/5 px-6 py-4 flex items-center justify-between bg-[#020609]/80 backdrop-blur-xl">
        ...
        <div className="flex items-center gap-6">
          <button onClick={() => navigate("/login")} className="text-sm font-semibold text-gray-400 hover:text-white transition-colors">Log in</button>
          <button 
      ...
      <main className="relative z-10">
        ...
        <section className="pt-40 pb-20 px-6 max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2 flex flex-col items-start text-left">
              ...
              >
                <Sparkles className="w-4 h-4 text-brand-400" /> Exclusively for SPIT students
              </motion.div>
              ...
              >
                No more scattered WhatsApp groups. No more missed opportunities. <br />
                <span className="text-white">SPITConnect brings your entire campus together.</span>
              </motion.p>
            ...
            >
              ...
              <div className="relative glass-pro border border-white/10 rounded-[2rem] overflow-hidden shadow-2xl bg-[#0b1015]/95">
                <div className="h-10 border-b border-white/10 flex items-center px-6 gap-2 bg-white/[0.03]">
                  ...
                  <div className="mx-auto text-[10px] font-mono text-gray-500 tracking-widest ">LIVE_DASHBOARD</div>
                </div>
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 rounded-2xl glass border border-white/10 flex flex-col gap-3">
                    <div className="flex items-center gap-2">
                       <div className="w-6 h-6 rounded-full bg-brand-500/20 flex items-center justify-center text-brand-400"><Laugh size={14}/></div>
                       <span className="text-[10px] font-bold text-gray-500 uppercase tracking-tighter">Anonymous • 2m ago</span>
                    </div>
                    <p className="text-xs font-medium text-gray-300">"Anyone knows if the DS Lab submission was extended? Asking for a friend... 💀"</p>
                  ...
                  <div className="p-4 rounded-2xl glass border border-white/10 flex flex-col gap-3">
                    <div className="flex items-center justify-between">
                       <span className="text-[10px] font-bold text-gray-500 uppercase">Campus Ranks</span>
                       <Trophy size={14} className="text-amber-500"/>
                    </div>
                    <div className="space-y-2">
                       <div className="flex items-center justify-between text-xs">
                          <span className="text-gray-400">1. Aryan (BE)</span>
                          <span className="text-brand-400 font-bold">4,280 XP</span>
                       </div>
                       <div className="flex items-center justify-between text-xs">
                          <span className="text-gray-400">2. Sneha (TE)</span>
                          <span className="text-brand-400 font-bold">4,120 XP</span>
                       </div>
                    </div>
                  </div>
                  ...
                  <div className="md:col-span-2 p-4 rounded-2xl bg-brand-500/10 border border-brand-500/20">
                     <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                           ...
                           <span className="text-[10px] font-black uppercase text-brand-400">Daily Challenge</span>
                        </div>
                        <span className="text-[10px] font-bold text-gray-500">Starts in 04:20:11</span>
                     </div>
                     <p className="text-xs font-bold text-white italic">"Optimize binary search for duplicate elements."</p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex flex-col items-center">
                   ...
                   <span className="text-[10px] font-bold text-gray-500 uppercase">Day Streak</span>
                </div>
              </motion.div>
            </motion.div>
          </div>
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-black tracking-tighter mb-4">What's inside SPITConnect?</h2>
            <p className="text-gray-400 text-lg font-medium">Everything you need, built natively for SPIT.</p>
          </motion.div>
            ...
            <div className="md:col-span-2 glass-card rounded-[2.5rem] p-8 relative overflow-hidden group border-purple-500/10 hover:border-purple-500/30">
               ...
               <div className="relative z-10 flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm font-medium max-w-md">Confessions, polls, and raw campus thoughts. Completely anonymous. Only for verified students.</p>
                  </div>
                  <div className="flex items-center gap-2 mt-4">
                     <span className="px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 text-[10px] font-black text-purple-400 uppercase tracking-widest">Real-time Feed</span>
                  </div>
               </div>
            </div>
            ...
            <div className="glass-card rounded-[2.5rem] p-8 relative overflow-hidden group border-orange-500/10 hover:border-orange-500/30">
               <div className="relative z-10 flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm font-medium">Build a habit. Stay consistent and climb the ranks.</p>
                  </div>
                  <div className="text-3xl font-black text-white/20 group-hover:text-orange-500/40 transition-colors">7+ DAYS</div>
               </div>
            </div>
            ...
            <div className="glass-card rounded-[2.5rem] p-8 relative overflow-hidden group border-brand-500/10 hover:border-brand-500/30">
               <div className="relative z-10 flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-gray-400 text-xs font-medium">Join 20+ interest-based hubs across campus.</p>
                  </div>
            ...
            <div className="glass-card rounded-[2.5rem] p-8 relative overflow-hidden group border-indigo-500/10 hover:border-indigo-500/30">
               <div className="relative z-10 flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-gray-400 text-xs font-medium">Internships and referrals, curated for you.</p>
                  </div>
                  <div className="p-2 bg-indigo-500/10 border border-indigo-500/20 rounded-lg text-[10px] font-bold text-indigo-400 uppercase">12 New Postings</div>
               </div>
            </div>
            ...
            <div className="glass-card rounded-[2.5rem] p-8 relative overflow-hidden group border-amber-500/10 hover:border-amber-500/30">
               <div className="relative z-10 flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-gray-400 text-xs font-medium">Never miss a workshop, fest, or seminar.</p>
                  </div>
                  <div className="text-[10px] font-black text-gray-500 uppercase tracking-widest">RSVP Directly</div>
               </div>
            </div>
               ...
               <div className="relative z-10 flex flex-col justify-between h-full">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-gray-400 text-sm font-medium max-w-md">Get unstuck faster. Match with seniors who have already taken your courses.</p>
                    </div>
            ...
            <div className="glass-card rounded-[2.5rem] p-8 relative overflow-hidden group border-amber-500/10 hover:border-amber-500/30">
               <div className="relative z-10 flex flex-col justify-between h-full">
                  <div>
                    ...
                    <p className="text-gray-400 text-xs font-medium">Compete monthly for the top campus spot.</p>
                  </div>
                  <div className="flex items-baseline gap-1">
                     <span className="text-2xl font-black text-white">#1</span>
                     <span className="text-[10px] font-bold text-gray-500 uppercase">Campus Rank</span>
                  </div>
               </div>
            </div>
          </div>
        ...
        <section className="py-24 relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-20">
              ...
              >
                SPIT is active. <br />
                <span className="text-gray-500">But everything is scattered.</span>
              </motion.h2>
              <p className="text-gray-400 text-lg max-w-2xl mx-auto font-medium">
                Information is dying in unread WhatsApp messages. We built a command center for your college life.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Opportunities lost in chats", desc: "Internal referrals and team openings get buried under memes and stickers.", icon: <Briefcase className="w-6 h-6 text-red-400"/> },
                { title: "Important updates missed", desc: "Official notices and hackathon alerts disappear in the noise of 50+ groups.", icon: <Megaphone className="w-6 h-6 text-amber-400"/> },
                { title: "Too many groups, no clarity", desc: "Managing 15 groups for 5 subjects is a mental drain. We bring order.", icon: <Zap className="w-6 h-6 text-indigo-400"/> },
                { title: "No proper collaboration", desc: "Finding project partners shouldn't feel like a cold email campaign.", icon: <Users className="w-6 h-6 text-brand-400"/> }
              ].map((item, i) => (
                <motion.div
                  key={i}
                  whileHover={{ y: -5 }}
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="flex flex-col lg:flex-row items-end justify-between mb-20 gap-8">
              <div className="text-left">
                <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4">Your entire campus. Organized.</h2>
              ...
              <div className="flex items-center gap-4 border border-white/10 rounded-2xl px-6 py-4 glass">
                 <div className="text-center">
                    <div className="text-2xl font-black text-white line-clamp-1">350+</div>
                    <div className="text-[10px] uppercase font-bold text-gray-500">Daily Active</div>
                 </div>
                 <div className="w-px h-10 bg-white/10"></div>
                 <div className="text-center">
                    <div className="text-2xl font-black text-white">20+</div>
                    <div className="text-[10px] uppercase font-bold text-gray-500">Communities</div>
                 </div>
              </div>
            </div>
                  ...
                  <div>
                    <div className="flex flex-wrap gap-2 mb-4">
                       {feature.tags.map(tag => (
                          <span key={tag} className="px-2 py-0.5 rounded-full bg-white/5 border border-white/5 text-[9px] font-bold text-gray-500 uppercase tracking-widest">{tag}</span>
                       ))}
                    </div>
        ...
        <section className="py-32 relative z-10">
           <div className="max-w-7xl mx-auto px-6">
              <div className="mb-20">
                <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4">Not just a platform. <br /> <span className="text-brand-400">A daily habit.</span></h2>
                <p className="text-gray-400 text-lg max-w-2xl font-medium">
                  Compete with your peers, maintain your streak, and build a campus reputation that gets you noticed.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 auto-rows-[320px]">
                 ...
                 <div className="glass-card rounded-[3rem] p-10 relative overflow-hidden group flex flex-col justify-between border-orange-500/10 hover:border-orange-500/30">
                    ...
                    <div className="relative z-10">
                       ...
                       <p className="text-gray-400 text-sm font-medium">Show up every day, stay ahead. Consistency is the only metric that matters.</p>
                    </div>
                    <div className="relative z-10 w-full p-4 rounded-2xl bg-black/40 border border-white/5 backdrop-blur-md">
                       <div className="flex items-center justify-between mb-2">
                          <span className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Active SPITians</span>
                          <span className="text-[10px] font-black text-orange-500">LIVE</span>
                       </div>
                       <div className="flex items-baseline gap-2">
                          <span className="text-3xl font-black text-white">214</span>
                          <span className="text-sm font-bold text-gray-500 italic">currently on a 10+ day streak</span>
                       </div>
                    </div>
                 </div>
                 ...
                 <div className="glass-card rounded-[3rem] p-10 relative overflow-hidden group border-amber-500/10 hover:border-amber-500/30">
                   ...
                   <p className="text-gray-400 text-sm font-medium mb-8">Climb the ranks. The top contributors get exclusive access to campus networking events.</p>
                      ...
                      {[
                        ...
                        <div key={user.rank} className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/5">
                           <div className="flex items-center gap-3">
                              <span className="text-xs font-bold text-gray-500">#{user.rank}</span>
                              <span className="text-xs font-bold text-gray-200">{user.name}</span>
                           </div>
                           <span className="text-xs font-black text-amber-500">{user.xp} XP</span>
                        </div>
                      ))}
                   </div>
                 </div>
                 ...
                 <div className="glass-card rounded-[3rem] p-10 relative overflow-hidden group border-indigo-500/10 hover:border-indigo-500/30">
                    ...
                    <p className="text-gray-400 text-sm font-medium mb-8">Test your skills every 24 hours. From puzzles to code snippets, stay sharp.</p>
                    
                    <div className="p-6 bg-[#0c1117] rounded-2xl font-mono text-xs border border-white/5 shadow-inner">
                       <span className="text-brand-400">while</span> (<span className="text-indigo-400">curiosity</span>): <br />
                       &nbsp;&nbsp;<span className="text-amber-400">learn_more</span>() <br />
                       &nbsp;&nbsp;<span className="text-brand-400">maintain_streak</span>(<span className="text-white">today</span>)
                    </div>
                 </div>
              </div>
              ...
              <div className="mt-16 text-center">
                 <p className="text-2xl font-black text-gray-500 tracking-tighter italic lowercase">
                   Compete. Stay consistent. <span className="text-brand-400">Get recognized.</span>
                 </p>
              </div>
           </div>
        </section>
           ...
           <div className="max-w-7xl mx-auto px-6">
              <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-20">
                 <div className="max-w-2xl">
                    <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4">What’s really happening <br /> inside SPIT 👀</h2>
                    <p className="text-gray-400 text-lg font-medium">The heartbeat of campus. Anonymous. Real. Raw.</p>
                 </div>
              ...
              <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                 ...
                 <div className="glass-card p-6 break-inside-avoid border-purple-500/10">
                    <div className="flex items-center gap-2 mb-4">
                       <div className="w-8 h-8 rounded-full bg-purple-500/10 flex items-center justify-center text-purple-400"><Laugh size={16}/></div>
                       <span className="text-[10px] font-black uppercase text-gray-500 tracking-widest">Anonymous Confession</span>
                    </div>
                    <p className="text-lg font-medium text-white italic leading-relaxed">"Still haven't told my group that I haven't even installed the IDE for our project due tomorrow... God help me 😭"</p>
                 ...
                 <div className="glass-card p-6 break-inside-avoid border-brand-500/10">
                    <div className="flex items-center gap-2 mb-4">
                       <div className="w-8 h-8 rounded-full bg-brand-500/10 flex items-center justify-center text-brand-400"><BarChart3 size={16}/></div>
                       <span className="text-[10px] font-black uppercase text-gray-500 tracking-widest">Campus Poll</span>
                    </div>
                    <p className="text-sm font-bold text-white mb-4">Best spot to study during finals?</p>
                    <div className="space-y-2">
                       <div className="relative p-3 rounded-xl border border-white/5 bg-white/5 overflow-hidden">
                          ...
                          <div className="relative flex justify-between text-[11px] font-bold"><span>Library (Quiet Zone)</span><span>64%</span></div>
                       </div>
                       <div className="relative p-3 rounded-xl border border-white/5 bg-white/5 overflow-hidden">
                          <div className="absolute inset-0 bg-brand-500/10 w-[36%]"></div>
                          <div className="relative flex justify-between text-[11px] font-bold"><span>Cafeteria</span><span>36%</span></div>
                       </div>
                    </div>
                 </div>
                 ...
                 <div className="glass-card p-6 break-inside-avoid border-indigo-500/10">
                    <div className="flex items-center gap-2 mb-4">
                       <div className="w-8 h-8 rounded-full bg-indigo-500/10 flex items-center justify-center text-indigo-400"><Megaphone size={16}/></div>
                       <span className="text-[10px] font-black uppercase text-gray-500 tracking-widest">Hot Take</span>
                    </div>
                    <p className="text-base font-medium text-gray-300">"The new cafeteria coffee is actually better than Starbucks. Don't @ me."</p>
                    <div className="mt-4 flex items-center gap-4">
                        ...
                        <span className="text-[10px] font-bold text-gray-500 italic">24 students agree</span>
                    </div>
                 </div>
              </div>
           </div>
        ...
        <section className="py-24 relative overflow-hidden">
           <div className="max-w-7xl mx-auto px-6">
              <div className="glass p-12 md:p-20 rounded-[4rem] text-center border border-white/10 relative overflow-hidden">
                 ...
                 <div className="relative z-10">
                    <h2 className="text-3xl md:text-5xl font-black tracking-tighter mb-16">Already growing across SPIT</h2>
                    
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                       <div>
                          <div className="text-4xl md:text-6xl font-black text-white mb-2">500+</div>
                          <div className="text-xs font-bold text-gray-500 uppercase tracking-widest">Verified Students</div>
                       </div>
                       <div>
                          <div className="text-4xl md:text-6xl font-black text-brand-400 mb-2">2.4k</div>
                          <div className="text-xs font-bold text-gray-500 uppercase tracking-widest">Monthly Posts</div>
                       </div>
                       <div>
                          <div className="text-4xl md:text-6xl font-black text-indigo-400 mb-2">850</div>
                          <div className="text-xs font-bold text-gray-500 uppercase tracking-widest">Active Members</div>
                       </div>
                       <div>
                          <div className="text-4xl md:text-6xl font-black text-purple-400 mb-2">120+</div>
                          <div className="text-xs font-bold text-gray-500 uppercase tracking-widest">Opportunities</div>
                       </div>
                    </div>
                 </div>
              </div>
        ...
        <section className="py-32 px-6">
           <motion.div
              ...
              viewport={{ once: true }}
              className="max-w-5xl mx-auto glass-pro p-16 md:p-24 rounded-[4rem] text-center border-2 border-brand-500/20 relative shadow-[0_0_100px_rgba(20,184,166,0.15)] overflow-hidden"
           >
              <div className="absolute inset-0 bg-gradient-to-br from-brand-500/20 via-transparent to-indigo-500/20"></div>
              
              <div className="relative z-10">
                 <h2 className="text-4xl md:text-7xl font-black tracking-tighter mb-6">If you're in SPIT, <br /> you should be here.</h2>
                 <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
                   Don’t miss out on what your campus is building. Join the conversation, find your team, and stay in the loop.
                 </p>
                 ...
                 <p className="mt-8 text-xs font-bold text-gray-600 uppercase tracking-[0.2em]">Verified SPIT credentials required to join</p>
              </div>
           </motion.div>
        </section>
         ...
         <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 text-gray-500">
               <div className="flex items-center gap-2">
                  ...
                  <span className="font-black text-white tracking-widest uppercase">SPITConnect</span>
               </div>
               <div className="flex gap-8 text-xs font-bold tracking-widest uppercase">
                  <a href="#" className="hover:text-brand-400">About</a>
                  <a href="#" className="hover:text-brand-400">Guidelines</a>
                  <a href="#" className="hover:text-brand-400">Support</a>
               </div>
               <p className="text-[10px] font-medium">Built by Students. For the Campus. © 2026</p>
            </div>
         </div>
      </footer>
    </div>
